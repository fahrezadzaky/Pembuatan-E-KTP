                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://www.google.com/maps/place/Kantor+Kecamatan+Trawas/@-7.6647217,112.6013086,15z/data=!4m6!3m5!1s0x2e7877ec22a74fef:0x53acced39631840b!8m2!3d-7.6647217!4d112.6013086!16s%2Fg%2F1hm2xyn5_?entry=ttu" style="color:white"><i class="fa fa-podcast"> Kantor Desa Trawas Cek Lokasi disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> kecamatan_trawas@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>0817-1567-5345</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                <h3> Web Pendaftaran E-KTP <br>
                                    Kecamatan Trawas</h3>
                                <p>Selamat datang di web Pembuatan E-KTP Masyarakat Kecamatan Trawas<br>
                        ...
                        <div class="col-xl-12">
                            <div class="slider_text ">
                               <h3> Web Pelaporan<br>
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Kecamatan Trawas<br>
                                    Silahkan Registrasi dan Login dengan akun anda.</p>
                                <div class="video_service_btn">
                                    <a href="registrasi.php" class="boxed-btn3"><i class="fa fa-user-plus"> Registrasi disini</i></a>
                                    <a href="Login/index.php" class="boxed-btn3"> <i class="fa fa-sign-in"></i>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Trawas</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
