                        ...
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3> Web Pendaftaran E-KTP <br>
                                    Kecamatan Trawas</h3>
                                <p>Selamat datang di web Pendaftaran E-KTP Kecamatan Trawas<br>
                                ...
                                <div class="video_service_btn">
                                    ...
                                    <a href="pendaftaran.php" class="boxed-btn3">Pendaftaran disini</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="slider_text ">
                               <h3> Web Pelaporan<br>
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Kecamatan Trawas<br>
                                    Silahkan adukan Keluh Kesah anda terhadap Kecamatan Trawas</p>
                                <div class="video_service_btn">
                                    <a href="#" class="boxed-btn3" style="text-transform: uppercase; font-size:15px"><i class="fa fa-user"> <?php echo $_SESSION['nama']?></i></a>
