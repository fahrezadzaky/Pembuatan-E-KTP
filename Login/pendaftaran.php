                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                           ...
                                           <i class="fa fa-bar-chart" style="color:white"><li><a class="active" href="pendaftaran1.php">Pendaftaran Saya</a></li></i>
...
if (isset($_POST['simpan'])){
	...
	if($tambah){
		...
		echo "<meta http-equiv='refresh' content='1;url=pendaftaran1.php'>";
		} else {
...
?>
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                <h3 style="color:white"> Web Pendaftaran E-KTP <br>
                                    Kecamatan Trawas</h3>
                                <p style="color:white">Selamat datang di web Pendaftaran E-KTP Kecamatan  Trawas<br>
                                    Silahkan daftarkan diri anda</p>
                                <div class="video_service_btn">
                                    <a href="#" class="boxed-btn3" style="text-transform: uppercase; font-size:15px"><i class="fa fa-user"> <?php echo $_SESSION['nama']?></i></a>
                                    <a href="pengaduan.php" class="boxed-btn3">Pendaftaran disini</a>
                                    </div>
                    </div>
                        </div>
                    </div>
    ...
    <h4 class="tulisan_input2">PENDAFTARAN</h4>
    <table class="table2" width="40%" align="center">
<form method="post">
<input type="hidden" name="id" class="form_input2">
<td><h7>TANGGAL PENDAFTARAN</h7></td><td><input type="text" name="tgl" class="form_input2" required value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d (H:i:s)') ?>" readonly></td>
</tr>
<tr>
...
<tr>
<td><h7>ALAMAT</h7></th><td><textarea name="laporan" cols="90" required rows="8"></textarea></td>
</tr>
<tr>
<td><h7>NO TELEPON</h7></th><td><input type="text" name="tlp" required class="form_input2" value="<?php echo $_SESSION['tlp']?>" readonly></td>
</tr>
<tr>
<td><h7>FOTO KK</h7></th><td><input type="file" required name="gambar"></td>
</tr>
<tr>
<td><input type="hidden" name="st" value="Proses"></td>
</tr>
<tr>
<td colspan="2"><button type="submit" class="btn btn-success" name="simpan" style="float:left; margin-right:25px;">Daftar</button>
