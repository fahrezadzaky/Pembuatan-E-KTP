                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="../index.php">
                                        <img src="../img/logo lapor.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                     ...
                                     <i class="fa fa-bar-chart" style="color:white"><li><a class="active" href="pendaftaran1.php">Pengaduan Saya</a></li></i>
                                    </nav>
                                </div>
                            </div>
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Kec. Trawas<br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan Desa Trawas</p>
...
<div>
<center><a class="btn btn-dark" href="pendaftaran1.php" style="width:30%;">Kembali</a></p></center>
</div>
</form>
    </div>
    <footer class="footer">
